...
```sh
$ npm install sails-generate-account
```

[![NPM](https://nodei.co/npm/sails-generate-account.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generate-account/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/sails-generate-account/FAQ.md)
